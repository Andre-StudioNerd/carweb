              ...
              <div className="sm:col-span-3">
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 text-body-md border border-neutral-divisor rounded-lg focus:outline-none focus:ring-2 focus:ring-secondary-pure focus:border-transparent placeholder-black"
